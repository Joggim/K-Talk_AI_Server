...
model.load_state_dict(torch.load("/Users/seoyun/Desktop/K-Talk_AI_Server/app/models/mlp_pronunciation_classifier.pt"))
model.eval()

label_encoder = joblib.load("/Users/seoyun/Desktop/K-Talk_AI_Server/app/models/label_encoder.pkl")
